...
<footer class="footer">
	<div class="container footer__container">
		<div class="footer__subscribe">
			...
			<form action="https://bee-space.us19.list-manage.com/subscribe/post?u=3750b10ca1080d2dbf08fc785&amp;id=5285c1cc17" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
			...
			<input type="email" value="" name="EMAIL" class="required email footer__subscribe-input" id="mce-EMAIL" placeholder="Enter your email address" >
			    ...
			    <div style="position: absolute; left: -5000px;" aria-hidden="true"><input type="text" name="b_3750b10ca1080d2dbf08fc785_5285c1cc17" tabindex="-1" value=""></div>
